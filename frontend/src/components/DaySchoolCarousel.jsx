...
function DaySchoolCarousel() {
  ...
  const [playSchools, setPlaySchools] = useState([]);
...
/>
  ...
  return (
    <>
      {renderCarousel("Day Schools", daySchools)}
      {renderCarousel("Play Schools", playSchools)}
      {renderCarousel("Boarding Schools", boardingSchools)}
    </>
  );
}
